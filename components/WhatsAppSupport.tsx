  ...
  return (
    <section className="section-alt section-padding">
      <div className="section">
        <ScrollReveal>
          <div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-[1fr_auto] md:gap-16">
            <div className="order-2 text-center md:order-1 md:text-left">
              ...
              <p className="mt-5 max-w-lg text-base leading-relaxed text-muted mx-auto md:mx-0 sm:text-lg">
                ...
                ayudo con la compra o con cualquier duda.
              </p>
            ...
            <div className="relative mx-auto shrink-0 order-1 md:order-2">
              <div className="portrait-ring h-36 w-36 sm:h-44 sm:w-44">
                <img
