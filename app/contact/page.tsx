        ...
        <ScrollReveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-ink/50">
              &iquest;Tienes alguna pregunta? Escr&iacute;benos por WhatsApp y te respondemos en horario laboral.
            </p>
            <div className="section-divider mt-6" />
          </div>
        </ScrollReveal>

        <div className="mx-auto mt-14 max-w-lg space-y-6">
          <ScrollReveal>
            <div className="cute-card-static p-8 text-center">
              ...
              <h2 className="font-display text-2xl font-bold text-ink">Habla con Natalia</h2>
              <p className="mt-2 text-sm text-ink/50">
                Te ayudo con la compra, dudas sobre los patrones o cualquier consulta.
              </p>
              <a
                href="https://wa.me/573008504709"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-primary mt-6 inline-flex w-full items-center justify-center gap-2 py-4"
              >
          ...
          <ScrollReveal>
            <div className="glass-card p-6 text-center transition-all duration-300 hover:shadow-card-hover">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-rose-50 text-rose-500 transition-all duration-300 hover:bg-rose-500 hover:text-white hover:shadow-rose-glow"
                  aria-label="TikTok"
                >
